...
Besides from the main repository, you will also find various used helper libraries, package manager reposities, and the documentation website repository here.
